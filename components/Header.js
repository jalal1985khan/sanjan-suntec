...
<div className="wbg-menu">
   <div className="container">
      ...
      <small>Comply with all indirect taxation requirements through a dynamic enterprise taxation solution.</small></Link>
                           ...
                           <hr className="border"/>
                              <div className="row">
                                 <div className="col-sm-6">
                                    <ul className="nav-ul">
                                       <li className="mb-4">
                                          <Link href="/suntec-xelerate" className="text-decoration-none text-black">
                                             <h6>Xelerate</h6>
                                 ...
                                 <div className="col-sm-6">
                                    <ul className="nav-ul">
                                       <li className="mb-4">
                                       <Link href="/suntec-cloud" className="text-decoration-none text-black">
                                          <h6>Cloud</h6>
                           ...
                           <hr className="border"/>
                              <div className="row">
                                 <div className="col-sm-6">
                                    <ul className="nav-ul">
                                       <li className="mb-4">
                                          <Link href="/articles" className="text-decoration-none text-black">
                                             <h6>Articles</h6>
               ...
               <Link href="/contact" className="btn b-btn text-white">Contact</Link>
      </nav>
   </div>
</div>
