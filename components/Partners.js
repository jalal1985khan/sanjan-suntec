...
<Container fluid className=" p-5">
 <Container className="f_content text-center">        
<h2 className="mb-5">Partners</h2></Container>     
<Container>
<Row>
...
<Link href="/partners/" className="p-btn center">Learn more</Link>
</div>
</Col>
...
<Link href="/partners/" className="center">Learn more</Link>
</div>
</Col>
<Col className="cloud">
