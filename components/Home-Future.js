  ...
  return (
      <Container fluid className="future g-0 d-flex flex-column justify-content-center">
          <Row>
            ...
            <source src="/videos/Home-Pager-GIF.mp4" type="video/mp4"/>
                </video>
              </Col>
        </Row>
      </Container>
