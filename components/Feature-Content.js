...
<Col ><Link href="/press_release/suntec-business-solutions-appoints-pramod-perumparambil-as-chief-strategy-and-transformation-officer-csto" className="ft-text">
<div className="f_hover" sm={3}>  
