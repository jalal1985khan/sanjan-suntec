...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
          ...
          const data = await fetchWordPressData('case-studies', page);
          if (data) {
...
<Container className="p-3 b-banner" fluid style={{ 
      backgroundImage: `url("/images/case-studies.jpeg")` 
    }}>
                  ...
                  <Card className="p-posts" >
                    ...
                    <Card.Body className="posts">
                      ...
                      <Row>
                        ...
                        <Link key={post.id} href={`/case-studies/${post['slug']}`} className="float-right">
                        Read more
                      </Link>
                        </Col>
                      </Row>  
