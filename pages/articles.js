...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
          ...
          const data = await fetchWordPressData('articles', page);
          if (data) {
...
<p className="fs-5">Read up on the latest market developments and expert insights</p>
</div>
</div>
</Col> 
<Col >
                  ...
                  <Card className="p-posts" >
                    ...
                    <Card.Body className="posts">
                      ...
                      <Row>
                        ...
                        <Link key={post.id} href={`/articles/${post['slug']}`} className="float-right">
                        Read more
                      </Link>
                        </Col>
                      </Row>  
